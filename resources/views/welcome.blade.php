                ...
                <main class="mt-6">
                    <div class="container mx-auto p-4">
                        <div class="text-center mb-8">
                            <h1 class="text-4xl font-bold text-white">Bienvenue sur Teleslack</h1>
                            <p class="text-xl text-white mt-4">L'application pour envoyer des messages à Slack et
                                Telegram en toute simplicité.</p>
                        </div>

                        <div class="text-center mt-8">
                            <a href="{{ route('dashboard') }}"
                                class="bg-red-900 text-white py-2 px-4 rounded-md hover:bg-blue-600 transition duration-200">Commencer
                                maintenant</a>
                        </div>
                    </div>
                </main>

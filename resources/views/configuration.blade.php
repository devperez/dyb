        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                ...
                <form action="{{ route('settings.update') }}" method="POST">
                    ...
                    <!-- Telegram -->
                    <div class="mb-4">
                        <label for="telegram_bot_token" class="block text-sm font-medium text-gray-700">Telegram Bot
                            Token</label>
                    ...
                    <div class="mb-4">
                        <label for="telegram_channel_id" class="block text-sm font-medium text-gray-700">Telegram
                            Channel
                            ID</label>
